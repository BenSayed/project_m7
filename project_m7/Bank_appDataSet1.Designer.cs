...
namespace project_m7 {
    ...
    public partial class Bank_appDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Bank_appDataSet1.xsd";
        ...
        public partial class accountsDataTable : global::System.Data.TypedTableBase<accountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public accountsRow AddaccountsRow(int id, string firstname, string lastname, string cardnum, string password) {
            ...
            private void InitClass() {
                ...
                this.columncardnum.MaxLength = 15;
        ...
        public partial class accountsRow : global::System.Data.DataRow {
            ...
            public string cardnum {
                get {
                    try {
                        return ((string)(this[this.tableaccounts.cardnumColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'cardnum\' in table \'accounts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableaccounts.cardnumColumn] = value;
                }
            }
            ...
            public bool IscardnumNull() {
                return this.IsNull(this.tableaccounts.cardnumColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetcardnumNull() {
                this[this.tableaccounts.cardnumColumn] = global::System.Convert.DBNull;
            }
...
namespace project_m7.Bank_appDataSetTableAdapters {
    ...
    public partial class accountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[accounts] WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_cardnum = 1 AND [cardnum] IS NULL) OR ([cardnum] = @Original_cardnum)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[accounts] ([id], [firstname], [lastname], [cardnum], [password" +
                "]) VALUES (@id, @firstname, @lastname, @cardnum, @password);\r\nSELECT id, firstna" +
                "me, lastname, cardnum, password FROM accounts WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[accounts] SET [id] = @id, [firstname] = @firstname, [lastname] = @lastname, [cardnum] = @cardnum, [password] = @password WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_cardnum = 1 AND [cardnum] IS NULL) OR ([cardnum] = @Original_cardnum)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT id, firstname, lastname, cardnum, password FROM accounts WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::project_m7.Properties.Settings.Default.Bank_appConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstname, lastname, cardnum, password FROM dbo.accounts";
        ...
        public virtual int Fill(Bank_appDataSet.accountsDataTable dataTable) {
        ...
        public virtual Bank_appDataSet.accountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Bank_appDataSet.accountsDataTable dataTable = new Bank_appDataSet.accountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Bank_appDataSet.accountsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_firstname, string Original_lastname, string Original_cardnum, string Original_password) {
        ...
        public virtual int Insert(int id, string firstname, string lastname, string cardnum, string password) {
        ...
        public virtual int Update(int id, string firstname, string lastname, string cardnum, string password, int Original_id, string Original_firstname, string Original_lastname, string Original_cardnum, string Original_password) {
            ...
            if ((Original_cardnum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_cardnum));
            }
            if ((Original_password == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string cardnum, string password, int Original_id, string Original_firstname, string Original_lastname, string Original_cardnum, string Original_password) {
            return this.Update(Original_id, firstname, lastname, cardnum, password, Original_id, Original_firstname, Original_lastname, Original_cardnum, Original_password);
        }
    }
